germany_noise <- function(utmcrs, owndpi, grid_pop_prep, germany_noise_prepared, city_shapes) {
    #' @title Calculate exposed people Germany
    #' 
    ...
    #' @param germany_noise_prepared Noise data
    ...
    noise <- tar_read(germany_noise_prepared)
    ...
    for(noim in c("Lden", "Lnight")) {
        noise_map_function(cty = "Munich", noise_meas = noim)
    }
    ...
    openxlsx::write.xlsx(
        ...
        file.path(
            output_path,
            "descriptives/munich_exposed_day.xlsx"
        ),
        rowNames = FALSE
    )
    ...
    openxlsx::write.xlsx(
        ...
        file.path(
            output_path,
            "descriptives/munich_exposed_night.xlsx"
        ),
        rowNames = FALSE
    )
